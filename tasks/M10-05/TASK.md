...
Fleet of three managed runs visible and attachable; terminal recording in `tasks/M10-05/`.
...
- [ ] host check passes: `grep -c`
- [ ] `fleet.cast` is filed in the task folder.
- [ ] `fleet.txt` is filed in the task folder.
...
> `tasks/M10-05/fleet.cast` exists and `grep -c` of the three instance names in `tasks/M10-05/fleet.txt` is 3, the last of them on the attached row

## Evidence expected (D-118)

- `tasks/M10-05/fleet.cast` (host part)
- `tasks/M10-05/fleet.txt` (host part)

## Proof (browser/attach)

Attach lands in the capsule session of the chosen row.
