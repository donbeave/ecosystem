# M10-03 termrock: `TerminalPane` widget
...
termrock: `TerminalPane` widget.

## Scope

Scrollback, follow, selection over `TerminalCellSource` with input-forwarding outcomes (§8).
...
- `tasks/M10-03/verify.container.out` (container part, containing `status: DONE`)
