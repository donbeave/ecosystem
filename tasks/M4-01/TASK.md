# M4-01 Initial prompt delivery at launch
...
Initial prompt delivery at launch.
...
> entrypoint rendering tests per runtime
...
- `tasks/M4-01/verify.container.out` (container part, containing `status: DONE`)
