...
End-to-end from assignment to linked PR on the scratch repository of `tasks/M3-07/scratch-repo.txt`, pushed and opened with the App installation token from M8-01; evidence in `tasks/M8-03/`.
...
> `gh pr view` shows the PR from the branch with the issue identifier, and the installation token's `gh api /installation/repositories` listing contains the repository named in `tasks/M3-07/scratch-repo.txt`
...
GitHub shows the PR; Linear shows the PR URL as an attachment.
